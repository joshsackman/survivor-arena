...
const STRINGS = {
    en: {
        ...
        resume: 'Resume',
        quit: 'Quit to Menu',
        masterVolume: 'All sound',
        sfxVolume: 'Game sounds',
        musicVolume: 'Music volume',
        musicEnabled: 'Play music',
        difficulty: 'How hard',
        showFps: 'Show frame counter',
        screenShake: 'Shake the screen',
        reducedMotion: 'Calmer effects',
        colorblind: 'Easier-to-see colours',
        locale: 'Language',
        close: 'Close',
        ...
        criticalFlash: 'Flash on big hits',
        // iter-19: haptic feedback + remap UI strings.
        vibration: 'Buzz on a phone',
